<template>
  <svg @click="handleClick" width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg"
    :class="['star-svg', { 'is-favorite': favorite }]"
  >
    ...
    <path
      ...
      :fill="favorite ? 'rgb(236, 165, 57)' : '#BFBFBF'"
    />
  </svg>
</template>
